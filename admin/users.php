...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Platform üyelerini yönet</h5>
                <p>Herkese platformunuza katılmak için üye rollerini düzenlemeniz gerekir.</p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                 <?php
                                    echo '<a href="/admin/edituser.php/' . $getvar['id'] . '"><button type="button" class="btn btn-info m-b-xs">Üyelik Ayarları</button></a';
                                    ?>
